...
- **Bio-Signal Rejection**: Advanced ECG & EEG artifact removal (baseline wander, muscle noise, motion artifacts), and adaptive filtering.
- **Feature Extraction**: Digital filter design (IIR, FIR, Butterworth), time-frequency analysis, and statistical signal conditioning.
- **Applied ML**: AI-driven diagnostic models and predictive analytics for mobile healthcare frameworks.

### 🔌 Embedded Systems & Hardware Engineering
- **Firmware Development**: Real-time bare-metal programming for ARM Cortex-M and AVR microcontroller families.
- **Hardware Co-Design**: Schematic entry, multi-layer PCB layout, and prototyping using **Altium Designer** and Proteus.
...
- **N. Mousavi**, et al., "Artificial Immune System Modeling for Predicting the Binding of Peptides to MHC Class II Molecules," *5th Iranian Conference on E-Health and ICT Application in Medical Science*, 2012.
- F. Kazemi Faramarzi, ..., **N. Mousavi**, "Prediction of peptides binding to Major Histocompatibility class II Molecules using Machine learning methods," *IEEE EMBS iCBBE*, Shanghai, China, 2012.

---

## 📈 Research Interests & Goals
- Digital Health, mHealth, and Smart Wearable Medical Electronics.
- Advanced Biomedical Signal Decoupling (ICA/PCA, Wavelet Transform, Adaptive Filtering).
- Currently pursuing PhD opportunities and academic collaborations in Neuroengineering and Advanced Bioelectrics.

---

## 📫 Connect with Me
- **LinkedIn**: [najmemousavi](https://www.linkedin.com/in/najmemousavi/)
- **Email**: [Mousavi.elc@gmail.com](mailto:Mousavi.elc@gmail.com)

*“Engineering technology to better understand human physiology.”*
